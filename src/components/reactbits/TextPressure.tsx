    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach((span) => {
          ...
          if (alpha && span.style.opacity !== String(alphaVal)) span.style.opacity = String(alphaVal);
        });
      }
    ...
    () => (
      <style>{`
        ...
        .tp-stroke span::after {
          content: attr(data-char); position: absolute; left: 0; top: 0; color: transparent; z-index: -1;
